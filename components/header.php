                    ...
                    <nav class="navbar navbar-expand-md">
                        <div class="container-fluid">
                          <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
                            <ul class="navbar-nav">
                              <li class="nav-item">
                                <a class="nav-link menus <?= ($pagina_actual == "home") ? "active" : ""; ?>" aria-current="page" href="<?= $base_url; ?>">Home</a>
                              </li>
                              <li class="nav-item">
                                <a class="nav-link menus <?= ($pagina_actual == "autor") ? "active" : ""; ?>" href="<?= $base_url . "autor.php"; ?>">Autor</a>
                              </li>
                              <li id="menu-livros" class="nav-item dropdown">
                                <a class="nav-link menus <?= ($pagina_actual == "livro") ? "active" : ""; ?>" href="#" id="botao-livros" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                  Livros
                                </a>
                                <ul class="dropdown-menu" aria-labelledby="botao-livros">
                                  <?php $lista_livros = getListaLivros(); ?>
                                  <?php foreach($lista_livros as $l): ?>
                                    <?php if($pagina_actual == "livro" && $livro_id == $l["id"]): ?>
                              ...
                              <li class="nav-item">
                                <a class="nav-link menus <?= ($pagina_actual == "imprensa") ? "active" : ""; ?>" href="<?= $base_url . "imprensa.php"; ?>">Imprensa</a>
                              </li>
                              <li class="nav-item">
                                <a class="nav-link menus <?= ($pagina_actual == "contactos") ? "active" : ""; ?>" href="<?= $base_url . "contactos.php"; ?>">Contactos</a>
                              </li>
                            </ul>
                          </div>
                        </div>
            ...
            <div class="col-12 mx-auto d-block d-md-none">
                <div class="row">
                    <div class="col-12 titulo-pagina titulo mobile">
                      ...
                      <button onclick="ajustarBotaoMenuMobile()" class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
                          ...
                          <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
                            <ul class="navbar-nav mobile">
                              ...
                              <li class="nav-item dropdown">
                                <a class="nav-link menus <?= ($pagina_actual == "livro") ? "active" : ""; ?>" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                  Livros
                                </a>
