...
<body>
    ...
    <h1>Backoffice (CAROUSEL MOBILE)</h1>
    ...
    <div class="quadro">
        ...
        <table>
            ...
            <?php foreach($banners as $b): ?>
                ...
                <tr>
                    ...
                    <td>
                        <a href="../backoffice/actions/carousel-center.php?tipo=mobile&editar=<?= $b["id"]; ?>">Editar</a>
                        <br>
                        <a href="../backoffice/actions/carousel-center.php?tipo=mobile&deletar=<?= $b["id"]; ?>">Deletar</a>
                    </td>
                </tr>
        ...
        <a href="../backoffice/actions/carousel-center.php?tipo=mobile">
